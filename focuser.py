...
# from focuser_simulated import Focuser

foc = Focuser() # TODO ajouté ici
...
class devicestate:
    ...
    def on_get(self, req: Request, resp: Response, devnum: int):
        if not foc.isConnected(): ##IS DEV CONNECTED##: # TODO modifié ici
            resp.text = PropertyResponse(None, req,
...
class absolute:
    ...
    def on_get(self, req: Request, resp: Response, devnum: int):
        if not foc.isConnected() : ##IS DEV CONNECTED##:
            resp.text = PropertyResponse(None, req,
                            NotConnectedException()).json
            return
        ...
        try:
            ...
            ## GET PROPERTY ##
            # ----------------------
            val = foc.absolute #TODO c'est bien ici ?
            resp.text = PropertyResponse(val, req).json
        except Exception as ex:
            resp.text = PropertyResponse(None, req,
...
class tempcomp:
    ...
    def on_get(self, req: Request, resp: Response, devnum: int):
        ...
        try:
            ...
            val = foc.temp_comp #TODO à modifier ici raise Error
            resp.text = PropertyResponse(val, req).json
        except Exception as ex:
            resp.text = PropertyResponse(None, req,
    ...
    def on_put(self, req: Request, resp: Response, devnum: int):
        ...
        try:
            ...
            # -----------------------------
            # TODO a vérifier ici foc.temp_comp
            resp.text = MethodResponse(req).json
        except Exception as ex:
            resp.text = MethodResponse(req,
                            DriverException(0x500, 'Focuser.Tempcomp failed', ex)).json
